...
Write-Host "UPDATING POWER PASS WITH EXACT ORIGINAL COLORS (IMAGE 2)..." -ForegroundColor Green
Write-Host "==========================================================" -ForegroundColor Cyan
...
class _PowerPassScreenState extends State<PowerPassScreen> {
  int _selectedPlanIndex = 1; // డీఫాల్ట్‌గా 2వ పాస్ (20 Rides - Popular) సెలెక్ట్ అయి ఉంటుంది

  // రెండో ఇమేజ్ లోని ఖచ్చితమైన కలర్స్: 1=Blue, 2=Orange, 3=Green
  final List<Map<String, dynamic>> _plans = [
    {
      ...
      'color': const Color(0xFF0058FF), // Blue
      'lightColor': const Color(0xFFE5EEFF),
    },
    {
      'title': '20 Rides Pass',
      'price': '\u20B9399',
    ...
    },
    {
      ...
      'color': const Color(0xFF00A859), // Green
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Text('Instant activation on all Flash2Ride Nellore rides', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
              ],
            ),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Exact Hero Banner matching Image 2
            Container(
              width: double.infinity,
            ...
            // 3 Passes with Exact Original Colors from Image 2
            ...List.generate(_plans.length, (index) {
              final plan = _plans[index];
              final isSelected = _selectedPlanIndex == index;
              final Color planColor = plan['color'] as Color;
              final Color lightColor = plan['lightColor'] as Color;

              return Padding(
                padding: const EdgeInsets.only(bottom: 14.0),
                child: InkWell(
                  onTap: () {
                    // టచ్ చేయగానే ఆ పాస్ యొక్క ప్రత్యేకమైన కలర్ తో రౌండ్ డెకరేషన్ మారడం
                    setState(() {
                      _selectedPlanIndex = index;
                    });
                  },
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: Colors.white,
                      borderRadius: BorderRadius.circular(18),
                      // సెలెక్ట్ అయిన కార్డుకు ఆ పాస్ యొక్క స్వంత కలర్ బోర్డర్ (1=Blue, 2=Orange, 3=Green)
                      border: Border.all(
                        color: isSelected ? planColor : const Color(0xFFE2E8F0),
                        width: isSelected ? 2.0 : 1.0,
                      ),
                      boxShadow: [
                        BoxShadow(
                          color: isSelected ? planColor.withOpacity(0.15) : Colors.black.withOpacity(0.03),
                    ...
                    child: Row(
                      children: [
                        // Left Icon with each plan's distinct background and icon color
                        Container(
                        ...
                        // Center Info with matching price color from Image 2
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w900,
                                      color: planColor, // Blue for 1, Orange for 2, Green for 3
                                    ),
                                  ),
                        ...
                        // Right Buy Now Button with EACH PLAN'S dedicated color matching Image 2
                        ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: planColor, // Card 1: Blue, Card 2: Orange, Card 3: Green
            ...
            // Why Power Pass Section matching Image 2
            const Text(
              'Why Power Pass?',
...
Write-Host "Updated PowerPassScreen with Exact Original Colors (Blue, Orange, Green) at: $passFile" -ForegroundColor Green

Write-Host "`nVerifying Dart Analysis..." -ForegroundColor Yellow
& flutter analyze

Write-Host "`n==========================================================" -ForegroundColor Cyan
Write-Host "POWER PASS EXACT COLORS AND DYNAMIC BUTTONS RESTORED!" -ForegroundColor Green
