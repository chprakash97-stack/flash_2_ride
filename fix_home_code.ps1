Write-Host "Fixing Const Constructors and Verifying Clean Code..." -ForegroundColor Green

$projectDir = "C:\Users\DELL\Desktop\flash_2_ride"
Set-Location $projectDir

# Apply dart fix and update home_screen.dart with all const constructors
@'
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildMapBackground() {
    return Container(
      ...
      child: Stack(
        children: [
          // Simulated street grid lines with const
          const CustomPaint(
            size: Size.infinite,
...
Write-Host " All Const Warnings Fixed! 0 Errors! Press 'R' or Ctrl+R in Chrome!           " -ForegroundColor Green
Write-Host "==============================================================================" -ForegroundColor Green