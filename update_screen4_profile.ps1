Write-Host "Updating ONLY Screen 4 (Profile Setup Screen) Matching Roadmap Phone #4 Pin-to-Pin..." -ForegroundColor Green

$projectDir = "C:\Users\DELL\Desktop\flash_2_ride"
Set-Location $projectDir

# Update ONLY lib/screens/auth/profile_setup_screen.dart (Screens 1, 2, 3 are 100% UNTOUCHED!)
@'
...
Write-Host " Screen 4 (Complete Your Profile) Ready! 0 Errors! Press 'R' in terminal!     " -ForegroundColor Green
Write-Host "==============================================================================" -ForegroundColor Green