Write-Host "Updating Login Screen to Seamless Plain White with High-Contrast Buttons..." -ForegroundColor Green
...
Write-Host " Login Screen Seamlessly Converted to Plain White! Press 'R' or Ctrl+R!      " -ForegroundColor Green
Write-Host "==============================================================================" -ForegroundColor Green