Write-Host "Fixing remaining 2 issues in RideSelectionScreen & HomeScreen..." -ForegroundColor Green

# 1. Update RideSelectionScreen with Native Vector Icon
@'
...
# 2. Fix the unused local variable 'res' in HomeScreen
$home = Get-Content 'lib/screens/home/home_screen.dart'
$home = $home -replace 'final res = await Navigator.push', 'await Navigator.push'
$home | Set-Content 'lib/screens/home/home_screen.dart' -Encoding UTF8
...
Write-Host " All Issues Completely Fixed!                                                 " -ForegroundColor Green
Write-Host "==============================================================================" -ForegroundColor Green