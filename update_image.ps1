...
if ($found) {
    Write-Host "SUCCESS! Found image file:" -ForegroundColor Green
    ...
    Write-Host "Opening file selector window so you can select the 10.17.53 PM image..." -ForegroundColor Yellow
...
Write-Host " 10.17.53 PM Image Updated! Press 'R' in terminal or Ctrl+R in Chrome!        " -ForegroundColor Green
Write-Host "==============================================================================" -ForegroundColor Green