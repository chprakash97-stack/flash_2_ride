Write-Host "Restoring HomeScreen with Complete Dual Search & Vector Icons..." -ForegroundColor Green
...
Write-Host " HomeScreen Fully Restored and Verified!                                      " -ForegroundColor Green
Write-Host "==============================================================================" -ForegroundColor Green