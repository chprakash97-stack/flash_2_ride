Write-Host "Fixing RideCategoryScreen parameters to resolve map_pin_picker_screen error..." -ForegroundColor Green
...
Write-Host " Error Resolved! Zero errors, Zero warnings! (No issues found!)               " -ForegroundColor Green
