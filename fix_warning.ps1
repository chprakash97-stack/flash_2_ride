Write-Host "Cleaning unused field in HourlyRentalsScreen..." -ForegroundColor Green
...
Write-Host " 100% Clean! Zero warnings, Zero errors!                                      " -ForegroundColor Green
Write-Host " On Hourly Rentals, click 'Book Now' to open Screen 11 (Flash Parcel)!       " -ForegroundColor Green
Write-Host "==============================================================================" -ForegroundColor Green